...
pub use skenion_contracts::{
    ...
    NumberRangeV01 as NumberRange, ObjectImplementationRefV01 as ObjectImplementationRefCurrent,
    ObjectProviderRefV01 as ObjectProviderRefCurrent,
    ObjectResolutionCandidateV01 as ObjectResolutionCandidateCurrent,
    ObjectResolutionDiagnosticCodeV01 as ObjectResolutionDiagnosticCodeCurrent,
    ObjectResolutionDiagnosticV01 as ObjectResolutionDiagnosticCurrent,
